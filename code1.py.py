...
import pickle
pickle.dump(svm_model, open('svm_model1.pkl', 'wb')) #svm has the highest accuracy

pickle.dump(scaler, open('scaler1.pkl', 'wb')) #save the std scaler too


# Importing additional dependencies for evaluation and plotting
from sklearn.metrics import confusion_matrix, classification_report
import matplotlib.pyplot as plt
import seaborn as sns

# Calculate Confusion Matrix and Classification Report for SVM
...
model_scores = [score * 100 for score in accuracies.values()]  # Convert to percentage
